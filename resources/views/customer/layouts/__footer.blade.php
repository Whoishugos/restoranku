    ...
    <div class="container py-5">
        <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
            <div class="row g-4">
                <div class="col-lg-6">
                    <a href="{{ route('menu') }}">
                        <h1 class="text-primary mb-0"> RESTORAN KEKUPU VILLA JEMBRANA</h1>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="footer-item">
                    ...
                    <p class="mb-4">Menyediakan layanan makan di tempat (dine-in) dengan berbagai menu makanan</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="footer-item">
